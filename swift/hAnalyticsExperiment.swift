...
public struct hAnalyticsExperiment {
  ...
  public static var connectPaymentReminder: Bool {
    ...
    hAnalyticsEvent.experimentEvaluated(name: "connect_payment_reminder", variant: "disabled")
      .send()
  ...
  public static var forever: Bool {
    ...
    hAnalyticsEvent.experimentEvaluated(name: "forever", variant: "disabled").send()
  ...
  public static var paymentScreen: Bool {
    ...
    hAnalyticsEvent.experimentEvaluated(name: "payment_screen", variant: "disabled").send()
  ...
  public static var showCharity: Bool {
    ...
    hAnalyticsEvent.experimentEvaluated(name: "show_charity", variant: "disabled").send()
