...
extension hAnalyticsEvent {
  ...
  @available(*, deprecated, message: "Replaced with screenView") public static func screenViewHome()
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = [:]
  ...
  @available(*, deprecated, message: "Replaced with screenView") public static func screenViewChat()
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = [:]
