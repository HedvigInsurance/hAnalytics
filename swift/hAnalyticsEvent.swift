...
extension hAnalyticsEvent {
  ...
  public static func honorPledgeConfirmed() -> hAnalyticsParcel {
    return hAnalyticsParcel {
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "honor_pledge_confirmed", properties: properties)
      )
    }
  }
  ...
  /// The state of notification permission: ///   granted == true: push notifications permissions are approved ///   granted == false: push notifications permissions are denied ///   granted == null: push notifications permissions are not determined yet / unknown
  ...
  public static func homePaymentCardClick() -> hAnalyticsParcel {
    return hAnalyticsParcel {
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "home_payment_card_click", properties: properties)
      )
    }
  }
  ...
  public static func paymentConnected() -> hAnalyticsParcel {
    return hAnalyticsParcel {
      ...
      hAnalyticsNetworking.send(hAnalyticsEvent(name: "payment_connected", properties: properties))
    }
  }

  /// When a user starts to record in an embark flow

  public static func embarkAudioRecordingBegin(storyName: String, store: [String: String?])
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = ["story_name": storyName, "store": store]

      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "embark_audio_recording_begin", properties: properties)
      )
    }
  }
  ...
  public static func embarkAudioRecordingPlayback(storyName: String, store: [String: String?])
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = ["story_name": storyName, "store": store]
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "embark_audio_recording_playback", properties: properties)
      )
    }
  }
  ...
  public static func embarkAudioRecordingRetry(storyName: String, store: [String: String?])
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = ["story_name": storyName, "store": store]
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "embark_audio_recording_retry", properties: properties)
      )
    }
  }
  ...
  public static func embarkAudioRecordingStopped(storyName: String, store: [String: String?])
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = ["story_name": storyName, "store": store]
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "embark_audio_recording_stopped", properties: properties)
      )
    }
  }
  ...
  public static func embarkAudioRecordingSubmitted(storyName: String, store: [String: String?])
    -> hAnalyticsParcel
  {
    return hAnalyticsParcel {
      let properties: [String: Any?] = ["story_name": storyName, "store": store]
      ...
      hAnalyticsNetworking.send(
        hAnalyticsEvent(name: "embark_audio_recording_submitted", properties: properties)
      )
    }
  }
