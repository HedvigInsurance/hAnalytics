...
extension hAnalyticsEvent {
    ...
    public static func claimDetailClickOpenChat(claimId: String,claimStatus: String) -> AnalyticsClosure {
        return AnalyticsClosure {
    ...
    public static func claimsStatusDetailScreenView(claimId: String,claimStatus: String) -> AnalyticsClosure {
        return AnalyticsClosure {
