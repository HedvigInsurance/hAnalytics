...
export class hAnalyticsTrackers {
  ...
  static claimDetailClickOpenChat(
    claimId: string,
    claimStatus: string
  ): () => void {
    return () => {
  ...
  // @deprecated Replaced with screenView
  static screenViewClaimsStatusDetail(
    claimId: string,
    claimStatus: string
  ): () => void {
    return () => {
  ...
  // @deprecated Replaced with screenView
  static screenViewDataCollectionAuthenticating(
    providerId: string
  ): () => void {
    return () => {
      const properties: { [name: string]: any } = {
  ...
  static embarkVariantedOfferRedirect(
    allIds: string[],
    selectedIds: string[]
  ): () => void {
    return () => {
