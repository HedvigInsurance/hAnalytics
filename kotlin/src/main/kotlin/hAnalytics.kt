...
data class AnalyticsClosure(
     ...
     */
    fun hAnalyticsEvent.Companion.claimCardVisible(claimId: String,claimStatus: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.claimDetailClickOpenChat(claimId: String,claimStatus: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.screenViewClaimsStatusDetail(claimId: String,claimStatus: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.embarkPassageGoBack(storyName: String,passageName: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.embarkTrack(storyName: String,eventName: String,store: Map<String, Any>): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.embarkVariantedOfferRedirect(allIds: Array<String>,selectedIds: Array<String>): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.screenViewDataCollectionAuthenticating(providerId: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.screenViewDataCollectionCredentials(providerId: String): AnalyticsClosure {
        return AnalyticsClosure {
     ...
     */
    fun hAnalyticsEvent.Companion.screenViewDataCollectionSuccess(providerId: String): AnalyticsClosure {
        return AnalyticsClosure {
